...
@NgModule({
  ...
  declarations:[GooglePlusButtonComponent, LinkedInButtonComponent, TweetButtonComponent, SocialIconsComponent, SocialShareComponent],
  exports: [GooglePlusButtonComponent, LinkedInButtonComponent, TweetButtonComponent, SocialIconsComponent, SocialShareComponent, MdIconModule]
})
